    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Movies123 address (e.g. CMRPxAsEZQfsnL5AxyCB4mDXixPJtkCBx2)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Movies123 address (e.g. CMRPxAsEZQfsnL5AxyCB4mDXixPJtkCBx2)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter Movies123 signature"));
#endif
