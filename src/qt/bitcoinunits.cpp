...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("123");
    case mBTC: return QString("m123");
    case uBTC: return QString::fromUtf8("μ123");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Movies123s"));
    case mBTC: return QString(QObject::tr("Milli-Movies123s (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Movies123s (1 / 1,000,000)"));
    default: return QString("???");
    }
}
