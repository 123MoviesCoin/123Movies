...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/movies123/tx/%s|https://coinplorer.com/123/Transactions/%s|https://explorer.novaco.in/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/movies123/tx/%s|https://coinplorer.com/123/Transactions/%s|https://explorer.novaco.in/tx/%s").toString();
