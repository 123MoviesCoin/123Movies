...
const string strMessageMagic = "Movies123 Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    } else if(nHeight >= 25 && nHeight <= 200){ 
    nSubsidy = 1000 * COIN; 
    } else if(nHeight >= 201 && nHeight <= 80025){ 
    nSubsidy = 100 * COIN; 
    } 
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("movies123-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Movies123
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Movies123", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "https://123movieshub.to/123movies https://123movieshub.to/film/paddington-2-23082/";
        CTransaction txNew;
        txNew.nTime = 1513990553;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print        
        block.print();
        assert(block.hashMerkleRoot == uint256("0x205e48ffbaabcebbbbea3f7540f8b79e3d39744cf6f8fe5fc72a4c6a4368d161"));
